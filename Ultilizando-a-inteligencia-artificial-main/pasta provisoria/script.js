...
function mosraAlternativas(){
    for(const alternatia of peruntaAtual.alternativas){
    const botaoAlternativas = document.createElement("button");
    botaoAlternativas.textContent = alterntaiva.texto;
    botaoAlternativas.addEventListener("click",() => respostaSelecionada(alternatia));
...
function respostaSelecionada(opicaoSelecionada){
    const afirmacoes = opicaoSelecionada.afirmacoes;
    historyFinal += afirmacoes +"";
    atual++;
    mostraPergunta();
}
